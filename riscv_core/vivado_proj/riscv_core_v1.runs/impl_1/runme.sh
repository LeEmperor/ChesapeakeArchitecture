...
HD_PWD='C:/FPGA_stuff/ChesapeakeArchitecture/riscv_core/vivado_proj/riscv_core_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_v1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toplevel_v1.tcl -notrace

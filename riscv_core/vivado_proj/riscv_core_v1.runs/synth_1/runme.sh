...
HD_PWD='C:/FPGA_stuff/ChesapeakeArchitecture/riscv_core/vivado_proj/riscv_core_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_v1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_v1.tcl

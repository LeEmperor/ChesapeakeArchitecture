...
namespace eval ::optrace {
  variable script "C:/FPGA_stuff/ChesapeakeArchitecture/riscv_core/vivado_proj/riscv_core_v1.runs/synth_1/toplevel_v1.tcl"
...
synth_design -top toplevel_v1 -part xc7s50csga324-1
...
write_checkpoint -force -noxdef toplevel_v1.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file toplevel_v1_utilization_synth.rpt -pb toplevel_v1_utilization_synth.pb"  } 
